import { setCountdownEndCallback } from './heart.js';
...
function startFireworks() {
    ...
    // Make the fireworks canvas visible
...
setCountdownEndCallback(() => {
    // Short delay to ensure heart canvas is cleared
    setTimeout(() => {
        // Hide the heart canvas
...
// Initially hide the fireworks canvas
